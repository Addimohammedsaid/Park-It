...
const char* ssid = "okami";
const char* password = "35a53744f27e";
int capture_interval = 20000; // Microseconds between captures
const char *post_url = "https://us-central1-iot-parking-8b09e.cloudfunctions.net/hello_http"; // Location where images are POSTED
...
void setup()
{
  ...
  // servo:
  ledcAnalogWrite(8, 20); // channel, valu
}
